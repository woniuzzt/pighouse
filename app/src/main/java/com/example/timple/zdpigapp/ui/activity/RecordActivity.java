    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0) {
                ...
                PigHouseAdapter adapter = new PigHouseAdapter(RecordActivity.this, list, TYPE_RECORD);
                rcvList.setLayoutManager(new LinearLayoutManager(RecordActivity.this));
