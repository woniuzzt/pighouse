 ...
 * 转群-》育肥舍
 */
public class YFSTurnToDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yfsturn_to_detail);
        ButterKnife.bind(this);

        tvToolbar.setText("转群 → 育肥舍");
    ...
    @OnClick({R.id.rb_yf, R.id.rb_tt, R.id.back, R.id.confirm})
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("下一个", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(YFSTurnToDetailActivity.this, ScanEarTagDetailActivity.class);
