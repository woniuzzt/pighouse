 ...
 * 转群-》母猪舍
 */
public class MZSTurnToDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mzsturn_to_detail);
        ButterKnife.bind(this);

        tvToolbar.setText("转群 → 母猪舍");
...
//                        Intent intent = new Intent(MZSTurnToDetailActivity.this, ScanEarTagDetailActivity.class);
