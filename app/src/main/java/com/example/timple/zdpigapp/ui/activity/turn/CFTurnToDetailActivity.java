...
public class CFTurnToDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cfturn_to_detail);
        ButterKnife.bind(this);

        tvToolbar.setText("转群 → 产房");
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("下一个", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(CFTurnToDetailActivity.this, ScanEarTagDetailActivity.class);
